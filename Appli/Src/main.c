...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*GPIO To init:
   * PB4 -> Uart7_TX -> Complete
   * PA11 -> UART4_RX -> complete
   * PA9 -> USART1_TX -> complete
   * PA8 -> UART7_RX -> Complete
   * PB13 -> UART5_TX -> complete
   * PB12 -> UART5_RX -> complete
   * PB15 -> USART1_RX -> complete
   * PB9 -> UART4_TX -> complete
   * PE1 -> UART8_TX -> complete
   * PE0 -> UART8_RX -> Complete
   * PG0 -> GPIO Out
   * PG1 -> GPIO Out
   * PG2 -> GPIO Out
   * PG3 -> GPIO Out
